...
dataframe_concat = pd.concat([dataframe,dataframe2],keys=['d1','d2']) #Concatena dataframes, pero identificando cada una mediante la función (keys)
print(dataframe_concat)

dataframe_concat = pd.concat([dataframe,dataframe2],ignore_index=True) #Concatena dataframes, ignorando el indice y dejandolos continuos
print(dataframe_concat)
